...
- [x] 2. Implement NotificationPermissionManager
  ...
  - [x] 2.2 Write property test for permission retry interval
    - **Property 11: 30-day retry interval**
    - **Validates: Requirements 3.4**
  
  - [x] 2.3 Write property test for timestamp update on rejection
    - **Property 12: Timestamp update on retry rejection**
    - **Validates: Requirements 3.5**
  
  - [x] 2.4 Implement permission request methods
  ...
  - [x] 2.5 Write property test for permission state tracking
    - **Property 10: Rejection timestamp storage**
    - **Validates: Requirements 3.3**

- [x] 3. Integrate permission requests in LoginActivity
  - [x] 3.1 Add permission request in onCreate after successful sign-in
  ...
  - [x] 3.2 Write property test for sign-in permission logic
    - **Property 8: Permission request at sign-in**
    - **Validates: Requirements 3.1**
  
  - [x] 3.3 Add onRequestPermissionsResult handler
    - Handle permission grant/deny results
    - Trigger FCM token registration on grant
    - Store rejection timestamp on deny
    - _Requirements: 3.3, 4.5_
  
  - [x] 3.4 Write property test for token registration after grant
    - **Property 16: Token registration after permission grant**
    - **Validates: Requirements 4.5**

- [x] 4. Integrate permission requests in HomeFragment
  - [x] 4.1 Add permission check in onResume
  ...
  - [x] 4.2 Write property test for Home Fragment retry logic
    - **Property 9: Permission retry at Home**
    - **Validates: Requirements 3.2**

- [x] 5. Implement FCMTokenManager
  - [x] 5.1 Create FCMTokenManager class
  ...
  - [x] 5.2 Write property test for token database sync
    - **Property 13: FCM token database sync**
    - **Validates: Requirements 4.2**
  
  - [x] 5.3 Integrate token registration on app start
    - Call registerToken() in MainActivity onCreate
    - Only register if permission is granted
    - Handle registration failures gracefully
    - _Requirements: 4.1, 4.5_

- [x] 6. Implement InstagameFCMService
  - [x] 6.1 Create InstagameFCMService extending FirebaseMessagingService
  ...
  - [x] 6.2 Implement notification display logic
  ...
  - [x] 6.3 Write property test for foreground notification display
    - **Property 14: Foreground notification display**
    - **Validates: Requirements 4.3**
  
  - [x] 6.4 Write property test for background notification display
    - **Property 15: Background notification display**
    - **Validates: Requirements 4.4**
  
  - [x] 6.5 Implement image download and processing
  ...
  - [x] 6.6 Write property test for image display
    - **Property 1: Notification image display**
    - **Validates: Requirements 1.1**
  
  - [x] 6.7 Write property test for aspect ratio handling
    - **Property 2: Aspect ratio handling**
    - **Validates: Requirements 1.2**
  
  - [x] 6.8 Implement graceful image failure handling
    - Catch image download exceptions
    - Display text-only notification if image fails
    - Log failures for monitoring
    - _Requirements: 1.4_
  
  - [x] 6.9 Write property test for graceful image failure
    - **Property 4: Graceful image failure**
    - **Validates: Requirements 1.4**
  
  - [x] 6.10 Write property test for text content preservation
    - **Property 3: Text content preservation**
    - **Validates: Requirements 1.3**

- [x] 7. Implement notification routing
  - [x] 7.1 Create notification click handling
  ...
  - [x] 7.2 Write property test for notification routing
    - **Property 5: Notification routing**
    - **Validates: Requirements 1.5**
  
  - [x] 7.3 Update MainActivity to handle notification intents
...
- [x] 8. Implement RemoteConfigManager
  - [x] 8.1 Create RemoteConfigManager class
  ...
  - [x] 8.2 Implement config fetching logic
  ...
  - [x] 8.3 Write property test for Remote Config fallback
    - **Property 7: Remote Config fallback**
    - **Validates: Requirements 2.5**
  
  - [x] 8.4 Write property test for cached values usage
    - **Property 19: Remote Config cached values**
    - **Validates: Requirements 7.3**
  
  - [x] 8.5 Implement version comparison logic
  ...
  - [x] 8.6 Write property test for version comparison
    - **Property 6: Version comparison logic**
    - **Validates: Requirements 2.2**
  
  - [x] 8.7 Write property test for invalid config handling
    - **Property 18: Invalid config handling**
    - **Validates: Requirements 5.5**
  
  - [x] 8.8 Implement force update flag logic
    - Add isForceUpdateEnabled() method
    - Return false if config fetch failed
    - Skip version check if flag is disabled
    - _Requirements: 5.3_
  
  - [x] 8.9 Write property test for force update flag behavior
    - **Property 17: Force update flag behavior**
    - **Validates: Requirements 5.3**

- [x] 9. Implement ForceUpdateDialog
  - [x] 9.1 Create ForceUpdateDialog DialogFragment
  ...
  - [x] 9.2 Implement Play Store navigation
...
- [x] 10. Integrate force update check in SplashActivity
  ...
  - [x] 10.3 Handle force update flow
...
- [x] 11. Add error handling and logging
  - [x] 11.1 Add exception handling throughout FCM service
  ...
  - [x] 11.2 Write property test for exception resilience
    - **Property 20: Exception resilience**
    - **Validates: Requirements 7.5**
  
  - [x] 11.3 Add error handling in RemoteConfigManager
  ...
  - [x] 11.4 Add error handling in token registration
